                                ...
                                <div class="row g-3">
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        ...
                                        <input type="text" class="form-control dt-input dt-full-name"
                                               data-column="1" placeholder="User name" data-column-index="0"/>
                                    </div>
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <label class="form-label">Email:</label>
                                        <input
                                            type="text" class="form-control dt-input email" data-column="2"
                                            placeholder="user@example.com" data-column-index="1"
                                        />
                                    </div>
                                    <div class="col-12 col-sm-6 col-lg-4">
